...
const Chapter03 = () => {
    ...
    // 나는 컴포넌트 내부에서 값을 사용할 때 무조건 state라는 것을 이용해야한다.
    // useState호출시 반드시 인자값을 넘겨야 함 --> 초기값
    ...
    /*
        ...
        React는 가상 DOM이라는 기술을 상요하여 변경된 부분만 실제 DOM에 반영
        => 이 과정을 재렌더링이라고 표현함

        state가 바뀌었네? => 함수 컴포넌트 다시 실행! ==> 실제 DOM가상 DOM 비교!
        => 바뀐 부분만 재렌더링 !! => 어 ? state가 바뀌었네? => 함수커뮤너트
